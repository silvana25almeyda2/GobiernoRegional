 ...
 * @author MYS1
 */
public class Caja_TUPA extends javax.swing.JFrame {
...
//        txtGrupo.setEditable(opcion);
    ...
    public void RESTAURAR_BARRA(){
        ...
        ImageIcon CambioS=new ImageIcon(this.getClass().getResource("/Imagenes/Iconos/Imagen/icons8-Save-22.png"));
        save.setIcon(CambioS);
        ImageIcon CambioC=new ImageIcon(this.getClass().getResource("/Imagenes/Iconos/Imagen/icons8-Long Arrow Left-22.png"));
...
//        txtGrupo.setText(String.valueOf(tb_CPT.getValueAt(fila, 7))); 
    ...
    public void NUEVO_REGISTRO(){
       if(txtct6.getText().equals("")|| txtGrupoDes.getText().equals("")||txtPORCENTAJE.getText().equals("")||txtNombre.getText().equals("")){
...
//                cno1.setID_GRUPO(Integer.parseInt(lblIDGRUPO.getText()));
                ...
                cno1.setNRO_ITEM("TP"+txtGrupoDes.getText());
...
//                cno1.setID_GRUPO(Integer.parseInt(lblIDGRUPO.getText()));
    ...
    public void MODIFICAR_UIT(){
                Caja_CPT cno1 = new Caja_CPT();
                if(txtPrecio_Base.getText().equals("")){
                    cargareliminar.setVisible(true);
                    cargareliminar.setBackground(new Color(255,91,70)); 
                    Mensaje.setText("Ocurrio un error, Verifique");
                    eli.setVisible(false);
            ...
            tb_CPT = new javax.swing.JTable(){
                ...
                panelVLayout.setHorizontalGroup(
                    ...
                    .addGroup(panelVLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(lblV, javax.swing.GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE)
                        .addContainerGap())
                );
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addContainerGap()
                                        .addComponent(lblNivel, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                                        .addComponent(lblPermiso))
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addContainerGap()
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(btnImprimir, javax.swing.GroupLayout.DEFAULT_SIZE, 241, Short.MAX_VALUE)
                ...
                eli1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Iconos/Imagen/icons8-Edit-22.png"))); // NOI18N
                eli1.setText("Editar");
                ...
                txtPrecio_Base.addKeyListener(new java.awt.event.KeyAdapter() {
                    public void keyTyped(java.awt.event.KeyEvent evt) {
                        txtPrecio_BaseKeyTyped(evt);
                    }
                });

                save.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
                save.setForeground(new java.awt.Color(51, 51, 51));
                save.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Iconos/Imagen/icons8-Save-22.png"))); // NOI18N
                ...
                cancel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Iconos/Imagen/icons8-Long Arrow Left-22.png"))); // NOI18N
                ...
                layout.setHorizontalGroup(
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jPanel5, javax.swing.GroupLayout.DEFAULT_SIZE, 661, Short.MAX_VALUE)
...
//        panelV.setVisible(false);
    ...
    private void txtPrecio_BaseKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPrecio_BaseKeyTyped
        try {
        ...
        if(tecla =='.' && txtPrecio_Base.getText().contains(".")){
            evt.consume();            
        }
    
    } catch (Exception e) {
    }
    }//GEN-LAST:event_txtPrecio_BaseKeyTyped
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Caja_TUPA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
